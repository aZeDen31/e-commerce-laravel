    ...
    <div class="col-md-8">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="article_name" name="article_name" value="{{ old('article_name') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="article_image" name="article_image" value="{{ old('article_image') }}">
            </div>
